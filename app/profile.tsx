...
export default function ProfileScreen() {
  const { user, token, refreshUser, logout, setUser } = useAuth();
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.profileSection}>
        ...
        {profilePic ? (
          <TouchableOpacity onPress={handleRemovePhoto} style={styles.photoBtn}>
            <Text style={styles.photoBtnText}>Remove Profile Picture</Text>
          </TouchableOpacity>
        ) : (
          <Text style={styles.noPhotoText}>No profile picture</Text>
        )}
      </View>
...
const styles = StyleSheet.create({
  ...
  photoBtn: { paddingVertical: 8, paddingHorizontal: 16 },
  photoBtnText: { color: '#ef4444', fontSize: 15 },
  noPhotoText: { color: '#999', fontSize: 14 },
